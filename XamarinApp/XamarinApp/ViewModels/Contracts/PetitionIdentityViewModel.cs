...
namespace XamarinApp.ViewModels.Contracts
{
    public class PetitionIdentityViewModel : BaseViewModel
    {
        ...
        {
            bool succeeded = await this.networkService.TryRequest(this.neuronService.Contracts.SendPetitionIdentityResponseAsync, this.requestedIdentityId, this.petitionId, this.requestorFullJid, true);
            if (succeeded)
            {
        ...
        {
            bool succeeded = await this.networkService.TryRequest(this.neuronService.Contracts.SendPetitionIdentityResponseAsync, this.requestedIdentityId, this.petitionId, this.requestorFullJid, false);
            if (succeeded)
            {
                await this.navigationService.GoBackAsync();
            }
