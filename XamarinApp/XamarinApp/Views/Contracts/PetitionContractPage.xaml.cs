...
namespace XamarinApp.Views.Contracts
{
	...
	public partial class PetitionContractPage
	{
		...
		public PetitionContractPage(LegalIdentity requestorIdentity, string requestorFullJid,
		...
		{
            await this.contractsService.SendPetitionContractResponseAsync(this.requestedContract.ContractId, this.petitionId, this.requestorFullJid, false);
            await this.navigationService.PopAsync();
		}
