...
namespace IdApp.Navigation.Wallet
{
    ...
    public class WalletNavigationArgs : NavigationArgs
    {
        ...
        private readonly PendingPayment[] pendingPayments;
        private readonly AccountEvent[] events;
        ...
        public WalletNavigationArgs(Balance Balance, decimal PendingAmount, string PendingCurrency, PendingPayment[] PendingPayments,
        ...
        /// </summary>
        public PendingPayment[] PendingPayments => this.pendingPayments;

        /// <summary>
        /// Wallet events.
        /// </summary>
        public AccountEvent[] Events => this.events;
