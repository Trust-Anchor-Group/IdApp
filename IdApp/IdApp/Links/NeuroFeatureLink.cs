...
namespace IdApp.Links
{
	...
	public class NeuroFeatureLink : ILinkOpener
	{
		...
		{
			return Link.Scheme.ToLower() == Constants.UriSchemes.UriSchemeNeuroFeature ? Grade.Ok : Grade.NotAtAll;
		}
		...
		public async Task<bool> TryOpenLink(Uri Link)
		{
			...
			await Services.NeuroWalletOrchestratorService.OpenNeuroFeatureUri(Link.OriginalString);
