...
namespace IdApp.Services.UI.QR
{
	...
	public static class QrCode
	{
		...
		private readonly static CustomColoring tokenCode = new CustomColoring(
			...
			67, 67, SKColors.SlateBlue, SKColors.White, SKColors.Black, SKColors.White,
			SKColors.DarkSlateBlue, SKColors.SlateBlue, SKColors.White,
			SKColors.DarkSlateBlue, SKColors.SlateBlue, SKColors.White);
	}
}
